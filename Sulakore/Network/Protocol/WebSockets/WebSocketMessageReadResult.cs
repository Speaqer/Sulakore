...
namespace Sulakore.Network.Protocol.WebSockets
{
    ...
    /// </summary>
    public readonly struct WebSocketMessageReadResult
    {
        /// <summary>
        ...
        public WebSocketMessageReadResult(ReadOnlySequence<byte> data, bool isEndOfMessage, bool isCanceled, bool isCompleted)
        {
            Data = data;
