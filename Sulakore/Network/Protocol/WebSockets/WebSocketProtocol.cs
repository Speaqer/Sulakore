...
namespace Sulakore.Network.Protocol.WebSockets
{
    ...
    public class WebSocketProtocol : IControlFrameHandler
    {
        ...
        /// </summary>
        /// <param name="transport">The underlying transport to use.</param>
        /// <param name="protocolType">The type of WebSocket protocol, server or client.</param>
        public WebSocketProtocol(IDuplexPipe transport, WebSocketProtocolType protocolType, IControlFrameHandler controlFrameHandler = default)
        {
            _transport = transport;
            _messageReader = new WebSocketMessageReader(transport.Input, controlFrameHandler ?? this);
            _messageWriter = new WebSocketMessageWriter(transport.Output, protocolType);
